                        ...
                        <tbody>
                            {this.props.todos.map(todo => (
                                <tr key={todo.id}>
                                    ...
                                    <td>
                                        <span className="btn btn-danger" onClick={() => this.props.deleteTodo(todo.id)}
                                            style={{ color: "white", fontSize: "20pt", marginRight: "20px" }}>Remove</span>
                                        <span className="btn btn-success" onClick={() => this.props.toggleTodo(todo.id)}
                                            style={{ color: "white", fontSize: "20pt" }}>Completed</span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
